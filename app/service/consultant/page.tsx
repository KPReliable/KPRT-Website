...
export default function ConsultantPage() {
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900">
      <Head>
        <title>TPI Consulting | KPRT Quality Intelligence</title>
      </Head>
      ...
      <section className="bg-[#0F172A] pt-40 pb-32 px-6 md:px-12 lg:px-24 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <h1 className="text-white text-5xl md:text-7xl font-bold max-w-4xl leading-[1.1] mb-8">
            Expert technical guidence to Navigate <br /> complex global quality standards seamlessly.
          </h1>
          <p className="text-slate-400 text-xl max-w-2xl mb-12 leading-relaxed">
            Strategic engineering insights to optimize your manufacturing standards and compliance
          </p>
