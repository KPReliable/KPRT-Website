      ...
      <div className="relative z-20 w-full max-w-7xl mx-auto px-6 md:px-12 lg:px-24">
        <div className="max-w-4xl">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-6xl font-extrabold text-white leading-tight mb-4">
            Leading Third-Party <br /> Inspection Services <br/>Automotive Industry
          </h1>
          <p className="text-white/90 text-lg md:text-xl max-w-2xl mb-10 leading-relaxed">
            Providing unbiased, independent, and professional TPI solutions to ensure your supply chain meets every technical specification and safety standard.
          </p>
      ...
      <div className="relative z-20 w-full max-w-[90rem] mx-auto px-4 md:px-8 lg:px-12">
        ...
        <div className="flex flex-col lg:flex-row gap-4 items-start justify-center w-full">
          ...
          <div className="flex flex-col gap-4 w-full lg:w-[25%]">
            <div className="relative w-full aspect-[4/5] overflow-hidden shadow-2xl">
              <Image src="https://res.cloudinary.com/dinnmia6e/image/upload/v1776186082/Ram27_rhjitx.svg" alt="TPI Field Work" fill className="object-cover" />
            </div>
          ...
          <div className="flex flex-col gap-4 w-full lg:w-[20%] lg:mt-24">
            <div className="relative w-full aspect-[3/4] overflow-hidden shadow-2xl border border-white/10">
              <Image src="https://res.cloudinary.com/dinnmia6e/image/upload/v1776189684/Ram33_pok5jk.svg" alt="Site Inspection" fill className="object-cover" />
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4 w-full lg:w-[35%]">
            <div className="relative w-full aspect-[16/10] overflow-hidden shadow-2xl">
              <Image src="https://res.cloudinary.com/dinnmia6e/image/upload/v1776189683/Ram34_ymldjn.svg" alt="Team Consultation" fill className="object-cover" />
            </div>
            <div className="flex flex-row gap-4 w-full">
              <div className="relative w-[45%] aspect-[4/3] overflow-hidden shadow-2xl">
                <Image src="https://res.cloudinary.com/dinnmia6e/image/upload/v1776530403/Ram46_ligbix.svg" alt="Equipment Check" fill className="object-cover" />
              </div>
              <div className="relative w-[55%] aspect-[3/4] overflow-hidden shadow-2xl">
                <Image src="https://res.cloudinary.com/dinnmia6e/image/upload/v1776189683/Ram34_ymldjn.svg" alt="Laboratory Testing" fill className="object-cover" />
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4 w-full lg:w-[20%] lg:mt-12">
            <div className="relative w-full aspect-[3/4] overflow-hidden shadow-2xl border border-white/10">
              <Image src="https://res.cloudinary.com/dinnmia6e/image/upload/v1777446853/Raj25_smlrv7.svg" alt="Compliance Meeting" fill className="object-cover" />
            </div>
          </div>
        </div>
        ...
        <div className="mt-16 md:mt-24 text-center max-w-4xl mx-auto px-4">
          ...
          <p className="text-blue-100/80 text-lg md:text-xl leading-relaxed">
            We serve as your technical eyes on the factory floor. From casting inspections to final assembly audits, KPRT ensures every component meets the rigorous safety and performance standards of global OEMs
          </p>
        </div>
      </div>
    </section>
      ...
      <div className="max-w-[1200px] w-full mx-auto">
        ...
        <header className="flex flex-col lg:flex-row lg:justify-between lg:items-end mb-12 gap-6">
          <h2 className="text-4xl md:text-5xl lg:text-[3.5rem] font-bold leading-[1.05] tracking-tight">
            Engineering Zero DefectsPrecision<br /> Audits for Global OEMs
          </h2>
          <p className="max-w-[380px] text-lg font-medium text-neutral-600 leading-relaxed lg:pb-2">
            Unbiased automotive auditing designed to eliminate defects and protect your brand's integrity at every stage of the assembly line.
          </p>
        </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          <div className="bg-[#aebcb0] aspect-[4/5] p-8 flex flex-col justify-between relative overflow-hidden rounded-sm">
            ...
            <span className="text-[1.1rem] font-bold tracking-tight text-[#1c1c1c]">Raw Material & Casting Audit</span>
          </div>
          ...
          <div className="bg-[#ded7c7] aspect-[4/5] p-8 flex flex-col justify-between relative overflow-hidden rounded-sm">
            ...
            <span className="text-[1.1rem] font-bold tracking-tight text-[#1c1c1c]">Visualizing the Inspection</span>
          </div>
          ...
          <div className="bg-[#fb9d05] aspect-[4/5] p-8 flex flex-col justify-between relative overflow-hidden rounded-sm">
            ...
            <span className="text-[1.1rem] font-bold tracking-tight text-[#1c1c1c]">Final PDI & Layout Inspection</span>
          </div>
...
// --- Main Page Component ---
export default function TpiIndustryPage() {
  return (
